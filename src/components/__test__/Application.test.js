...
*/
import { render, waitForElement, fireEvent, prettyDOM, getByText, getAllByTestId, getByAltText, getByPlaceholderText, queryByText, queryByAltText, getByDisplayValue } from "@testing-library/react";
...
describe("Application", () => {
  ...
  it("loads data, edits an interview and keeps the spots remaining for Monday the same", async () => {
    ...
    fireEvent.change(getByDisplayValue(appointment, "Archie Cohen"), { target: { value: "David"}});
    
    fireEvent.click(getByText(appointment, "Save"));

    // We don't want the spots to change for "Monday", since this is an edit.
    expect(getByText(appointment, "Saving")).toBeInTheDocument();
    await waitForElement(() => getByText(container, "David"));
